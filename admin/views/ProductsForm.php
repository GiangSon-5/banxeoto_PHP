...
<select class="form-control" style="width: 250px;" name="category_id">
    ...
    <?php endforeach; ?>
            ...
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2">Ngày bảo dưỡng</div>
                <div class="col-md-10">
                    <input type="date" value="<?php echo isset($record->ngaybaoduong)? $record->ngaybaoduong: null; ?>" name="ngaybaoduong" class="form-control" required>
                </div>
            </div>
            <div class="row" style="margin-top:5px;">
